...
def train_ann(X_train, targets):
    # training MLP
    mlp = MLPRegressor(hidden_layer_sizes=(14,14,14), activation='tanh', solver='lbfgs', max_iter=1500, tol=1e-12)
...
def get_loss_vc_epoch(X_train, targets):
    #mse = []
    mlp = MLPRegressor(hidden_layer_sizes=(14,14,14), activation='tanh', solver='adam', tol=1e-20, max_iter=716, warm_start=False)
...
#             #print("test mse: ", te_mse)
    ...
    #save_estimatives('original_test_square_rods_veins_te.csv', ds.targetsTesting)
    #save_estimatives('mlp_14_14_14_alpha_0.009_square_rods_veins_te_pc.csv', outputs)