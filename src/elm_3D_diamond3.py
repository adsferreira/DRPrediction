...
def train_ann(X_train, targets, f_name):
    # training ELM
    elm = pipeline.Pipeline([('rhl', RandomLayer(n_hidden=141, activation_func='tanh', alpha=0.75)),
...
if __name__ == '__main__':
    ...
    elm_path = prefix + phcs[0] + '/no_material' + polarization + '/ann_models/'
    elm_files = ['elm_141_diamond3_best.pkl']
    train = 1
    ...
    #save_estimatives('elm_141_alfa_0_7_test_diamond_pc.csv', outputs)