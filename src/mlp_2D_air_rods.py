...
def train_ann(X_train, targets, f_name):
    # training MLP
    mlp = MLPRegressor(hidden_layer_sizes=(21,21,21), activation='tanh', solver='lbfgs', max_iter=1500, tol=1e-12)
...
if __name__ == '__main__':
    ...
    mlp_files = ['mlp_21_21_21_air_rods_pc.pkl']
    ...
    save_estimatives('tri_lattice_phc.csv', ds.targetsTesting)
    #save_estimatives('mlp_21_21_21_tm_air_rods_pc.csv', outputs)