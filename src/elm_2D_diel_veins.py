...
def train_ann(X_train, targets, f_name):
    # training MLP
    elm = pipeline.Pipeline([('rhl', RandomLayer(n_hidden=60, activation_func='multiquadric', alpha=0.5)),
...
def load_model(path, mlp_model_file):
    elm = joblib.load(path + mlp_model_file) 
    return elm
...
if __name__ == '__main__':
    ...
    elm_files = ['elm_60_2D_diel_veins_pc_new.pkl']
    ...
    #save_estimatives('elm_60_2D_te_test_diel_veins_pc.csv', outputs)